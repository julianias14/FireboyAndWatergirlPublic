...
public class FireboyAndWatergirl {
    ...
    /**
     * Finds path from start (row 0 col 0) to end (row.length-1
     * col[row].length-1) of a 2D char "maze" By traveling horizontally or
     * vertically, the collectedDiamonds 2D array is used to represent visited
     * coordinates. ​
     *
     ...
     * @return int array of size 2 representing row and column of the end
     * coordinate if path is found, null otherwise
     */
    public static void nextStep(char[][] maze, int row, int col, boolean[][] collectedDiamonds, int hero) {

        // STUDENT CODE WOULD BE WRITTEN HERE //
    }
